...
<?= $form->field($model, 'email')->textInput(['placeholder' => 'E-mail'])->label('Ваш email')?>
...
<button type="button" id="save_email-button" class="popup-login-button">Додати</button>

<script>
    $(function(){
        jQuery('#save_email-button').ajaxSubmit({
            "loaderImage":"<?=$asAsset->baseUrl?>/load.gif",
            "url":"/ubi/email/add-email",
